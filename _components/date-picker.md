...
1. **Input label:** Label for each form input `<label for>`See [form inputs]({{site.baseurl}}/components/form-inputs)
1. **Spacing:** Horizontal and vertical gap `2` ;See [spacing]({{site.baseurl}}/foundations/spacing)
